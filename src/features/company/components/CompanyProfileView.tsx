    ...
    <div className="w-full">
      <div className="w-[1642px] h-[860px] mx-auto">
        ...
        <div className="flex items-center justify-between mb-5">
          <h1 className="text-2xl font-regular text-[#084072]">
            Company Profile
          </h1>
        ...
        {/* Card */}
        <div className="bg-[#FAFAFA] rounded-lg shadow px-8 py-8">
          <div className="grid grid-cols-[240px,1fr,1fr] grid-rows-[auto,auto] gap-x-[50px] gap-y-[50px]">
            {/* Logo (ซ้าย span 2 แถว) */}
            <div className="row-span-2">
              <div className="h-44 border-2 border-dashed border-[#B6DEFF] bg-[#F7FBFF] rounded-lg flex flex-col items-center justify-center text-sm text-[#525252]">
                {data.logoUrl ? (
                  <img
                    src={data.logoUrl}
                    alt="Company Logo"
                  ...
                  <span className="text-xs text-[#7A7A7A]">No Logo</span>
                )}
              </div>
            </div>
